    ...
    <link rel="stylesheet" type="text/css"
        ...
        <style>
            @media print {
                ...
                thead {
                    display: table-header-group !important; /* Ensures thead is repeated on each page */
                }

                tfoot {
                    /* display: table-footer-group !important; Ensures tfoot is repeated on each page */
                ...
                tr {
                    page-break-inside: avoid; /* Prevents page breaks inside rows */
                    page-break-after: auto; /* Allows page breaks after rows */
                }
                ...
                .border-top-1 {
                    border-top: 1px solid black; /* Ensures the top border is applied */
                }
            }
        </style>
