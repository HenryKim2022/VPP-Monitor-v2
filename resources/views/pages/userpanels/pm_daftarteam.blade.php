                            ...
                            <div class="card mb-0 w-100">
                                <div class="card-body pt-0">
                                    ...
                                    <span class="btn btn-primary auth-role-eng-text">
                                        <a class="mt-0 mb-0 cursor-default text-end">SUPERUSER</a>
                                    </span>
                                    {{-- </div> --}}
                    ...
                    columns: [{
                            ...
                            render: function(data, type, row) {
                                ...
                                <div class="dropdown d-lg-block d-sm-block d-md-block">
                                    <button class="btn btn-icon navbar-toggler" type="button" id="tableActionDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
