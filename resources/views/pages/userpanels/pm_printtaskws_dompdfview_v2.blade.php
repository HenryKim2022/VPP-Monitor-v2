...
<body>
    ...
    @foreach ($taskChunks as $index => $chunk)
        ...
        @php
            ...
            $maxCharsDescription = 46; // Max characters for DESCRIPTION
            $maxCharsTask = 29; // Max characters for TASK
        ...
        <div class="page">
            <table id="main-tb" class="table table-striped m-auto border-solid border-thin bg-trans">
                <thead class="border-left-bold border-right-bold">
                    ...
                    <tr>
                        <th rowspan="2" colspan="3" class="text-center align-middle cell-fit th-time">TIME
                            (WAKTU)</th>
                        <th rowspan="2" colspan="7" class="text-center align-middle">TASK</th>
                        <th rowspan="2" colspan="1" class="text-center align-middle">DESCRIPTION</th>
