                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        <div class="dropdown d-lg-block d-sm-block d-md-block">
                                                            <button class="btn btn-icon navbar-toggler pt-0"
                                                            ...
                                                            @if ($authUserType == 'Superuser' || $authUserType == 'Supervisor')
                                                                <div class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    {{-- @if ($authUserType == 'Superuser' || $authUserType == 'Supervisor' || $authUserType == 'Superuser' || $authUserId == $monUserId) --}}
                                                                    @if ($authUserType == 'Superuser' || $authUserType == 'Supervisor')
                                                                        @if ($authUserType == 'Superuser' || $authUserId == $monUserId)
    ...
    function ($task) use ($mon, $project) {
        ...
        // Check if the task's worksheet expired_ws is null
                            ...
                            <div class="row match-height MODALS-1">
                                <!-- BEGIN: AddMonitorModal--> @include('v_res.m_modals.userpanels.m_daftarmonitor.v_add_moniModal') <!-- END: AddMonitorModal-->
                                <!-- BEGIN: EditMonitorModal--> @include('v_res.m_modals.userpanels.m_daftarmonitor.v_edit_moniModal') <!-- END: EditMonitorModal-->
                                <!-- BEGIN: DelMonitorModal--> @include('v_res.m_modals.userpanels.m_daftarmonitor.v_del_moniModal') <!-- END: DelMonitorModal-->
                                @if ($reset_btn)
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="row w-100 justify-content-between">
                                                ...
                                                <div
                                                    ...
                                                    <span>
                                                        <strong>
                                                            <h3 class="mt-0 mb-0 underline-text pt-2">PROJECT<br>
                                                                WORKSHEET LIST<br>(DAFTAR LEMBAR KERJA)</h3>
                                                        </strong>
                                                        <i class="fas"></i>
                                                    </span>
                                                </div>
